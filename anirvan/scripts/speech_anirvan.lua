...
return {
	ACTIONFAIL =
	{
        REPAIR =
        {
            WRONGPIECE = "Esto no va aqui.",
        },
        BUILD =
        {
            MOUNTED = "Si estoy montando no llego.",
            HASPET = "Ya tengo mascota.",
        },
		SHAVE =
		{
			AWAKEBEEFALO = "Mejor espero a que se vaya a mimir.",
			GENERIC = "No hay barba para afeitar.",
			NOBITS = "No hay ni pelusilla.",
            REFUSE = "only_used_by_woodie",
		},
		STORE =
		{
			GENERIC = "Esta lleno.",
			NOTALLOWED = "Aqui no la puedo meter.",
			INUSE = "Dani lo esta usando.",
            NOTMASTERCHEF = "El Franciscano no me ha enseñado aun.",
		},
        CONSTRUCT =
        {
            INUSE = "Dani lo esta construyendo.",
            NOTALLOWED = "No cabe.",
            EMPTY = "Con las manitas no lo voy a construir.",
            MISMATCH = "Creo que esto no va asi.",
        },
		RUMMAGE =
		{	
			GENERIC = "No puedo hacer esto.",
			INUSE = "Estan hasta arriba.",
            NOTMASTERCHEF = "El Franciscano no me ha enseñado aun.",
		},
		UNLOCK =
        {
		...
		USEKLAUSSACKKEY =
        {
        	WRONGKEY = "Esto no va aqui.",
        	KLAUS = "¡Pero que coño!",
			QUAGMIRE_WRONGKEY = "Tengo que encontrar otra llave.",
        },
		ACTIVATE = 
		{
			LOCKED_GATE = "La puerta esta cerrada.",
		},
        COOK =
        {
            GENERIC = "No puedo cocinar ahora.",
            INUSE = "Dani esta cocinando.",
            TOOFAR = "¡No llego!",
        },
        ...
        FISH_OCEAN =
		{
			TOODEEP = "No voy a usar la caña buena en esta charca.",
		},
        ...
        GIVE =
        {
            GENERIC = "Eso no va ahi.",
            DEAD = "Creo que mejor me lo quedo.",
            SLEEPING = "No creo que le importe.",
            BUSY = "Ahora pruebo otra vez.",
            ABIGAILHEART = "Valio la pena intentarlo.",
            GHOSTHEART = "Esto es mala idea.",
            NOTGEM = "No voy a meter esto ahi",
            WRONGGEM = "Esta gema no va aqui.",
            NOTSTAFF = "No tiene la forma adecuada.",
            MUSHROOMFARM_NEEDSSHROOM = "Una seta mejor.",
            MUSHROOMFARM_NEEDSLOG = "Un tronco viviente mejor.",
            SLOTFULL = "Ya hemos puesto algo aqui.",
            FOODFULL = "Ya hay comida ahi.",
            NOTDISH = "No se va a comer eso.",
            DUPLICATE = "Este ya me lo se.",
            NOTSCULPTABLE = "No se como esculpir esto.",
            NOTATRIUMKEY = "Esto no va aqui.",
            CANTSHADOWREVIVE = "No puede resucitar.",
            WRONGSHADOWFORM = "Algo esta mal.",
            NOMOON = "Necesito ver la luna para que funcione.",
			PIGKINGGAME_MESSY = "Necesito pasar la aspiradora.",
			PIGKINGGAME_DANGER = "Peligroso.",
			PIGKINGGAME_TOOLATE = "Tarde.",
        },
        GIVETOPLAYER =
        {
            FULL = "Tienes los bolsillos llenos.",
            DEAD = "Creo que mejor me lo quedo.",
            SLEEPING = "Esta mimiendo.",
            BUSY = "Ocupado.",
        },
        GIVEALLTOPLAYER =
        {
        ...
        WRITE =
        {
            GENERIC = "Creo que esta bien asi",
            INUSE = "Dani esta escribiendo.",
        },
        DRAW =
        {
            NOIMAGE = "Necesito un modelo.",
        },
        CHANGEIN =
        {
            GENERIC = "No quiero.",
            BURNING = "Peligroso",
            INUSE = "Dani se esta cambiando.",
        },
        ATTUNE =
        {
            NOHEALTH = "Estoy un poco low.",
        },
        MOUNT =
        {
            TARGETINCOMBAT = "No enfades a un Beefalo.",
            INUSE = "Dani me ha quitado la montura.",
        },
        SADDLE =
        {
            TARGETINCOMBAT = "No si esta enfadado.",
        },
        TEACH =
        {
            --Recipes/Teacher
            KNOWN = "Ya me la se.",
            CANTLEARN = "Solo me la aprendo con un video del franciscano.",

            --MapRecorder/MapExplorer
            WRONGWORLD = "Este mapa no es de aqui.",
        },
        WRAPBUNDLE =
        {
            EMPTY = "Necesito algo para envolver.",
        },
        PICKUP =
        {
			RESTRICTION = "No le se.",
			INUSE = "Dani lo esta usando.",
        },
        SLAUGHTER =
        {
        ...
        REPLATE =
        {
            MISMATCH = "Necesita otro tipo de plato.", 
            SAMEDISH = "Solo necesito uno.", 
        },
        SAIL =
        {
        	REPAIR = "Esta joya.",
        ...
        ROW_FAIL =
        {
            BAD_TIMING0 = "¡Muy pronto!",
            BAD_TIMING1 = "¡Mal timing!",
            BAD_TIMING2 = "¡Otra vez no!",
        },
        LOWER_SAIL_FAIL =
        {
            "Uy",
        ...
        BATHBOMB =
        {
            GLASSED = "Hay cristal en medio.",
            ALREADY_BOMBED = "Hay que ahorrar.",
        },
	},
	ACTIONFAIL_GENERIC = "No chabe.",
	ANNOUNCE_BOAT_LEAK = "Capitan nos hundimos.",
	ANNOUNCE_BOAT_SINK = "Imposible somos siete!",
	ANNOUNCE_DIG_DISEASE_WARNING = "Ya se ve mejor",
	ANNOUNCE_PICK_DISEASE_WARNING = "No huele un poco raro aqui?",
	ANNOUNCE_ADVENTUREFAIL = "Unlucky.",
    ANNOUNCE_MOUNT_LOWHEALTH = "Esta pochete.",
	...
	ANNOUNCE_BEES = "ABEJAAAAAS!!!!",
	ANNOUNCE_BOOMERANG = "No tengo coordinacion!",
	ANNOUNCE_CHARLIE = "Mi colegona",
	ANNOUNCE_CHARLIE_ATTACK = "No me toques!",
	ANNOUNCE_CHARLIE_MISSED = "only_used_by_winona", --winona specific 
	ANNOUNCE_COLD = "Coño que frio!",
	ANNOUNCE_HOT = "Mucho sol...",
	ANNOUNCE_CRAFTING_FAIL = "Me faltan cachifurros.",
	ANNOUNCE_DEERCLOPS = "Otra vez el deerclops!",
	ANNOUNCE_CAVEIN = "El cielo se cae!",
	...
	{
        "Sacrificio.",
        "Hormigaleon yo te ofrezco esto.",
        "Esto valdra, por ahora...",
	},
	ANNOUNCE_SACREDCHEST_YES = "Supongo que soy el elegido.",
	ANNOUNCE_SACREDCHEST_NO = "No le ha molado.",
    ANNOUNCE_DUSK = "Se va a hacer tarde... Nos cierra el SQRUPS.",
	...
	ANNOUNCE_EAT =
	{
		GENERIC = "Le doy un dos porque es comestible.",
		PAINFUL = "Peor que las lentejas de Mateo.",
		SPOILED = "En esta casa no se tira comida.",
		STALE = "Esto lo pillé del SQRUPS",
		INVALID = "Eso no es Halal.",
        YUCKY = "¡HARAM!",
    ...
    ANNOUNCE_ENCUMBERED =
    {
        ...
        "Llamad a la grua...",
        "COMO UN DRAGON",
        "No es un trabajo muy dandy...",
        "Ufff!",
        "Que se me arruga la camisa",
        "Hngh...!",
    },
    ...
    ANNOUNCE_RUINS_RESET = "Se han reseteado!",
    ANNOUNCE_SNARED = "Huesos afilados!!",
    ANNOUNCE_REPELLED = "Vaya parry!",
	ANNOUNCE_ENTER_DARK = "Que oscuro!",
	ANNOUNCE_ENTER_LIGHT = "Y se hizo la luz!",
	ANNOUNCE_FREEDOM = "Libertad!",
	ANNOUNCE_HIGHRESEARCH = "COMO UN DRAGON!",
	ANNOUNCE_HOUNDS = "Pero que coño?",
	ANNOUNCE_WORMS = "Gusanos?",
	ANNOUNCE_HUNGRY = "A comer!",
	ANNOUNCE_HUNT_BEAST_NEARBY = "Huele a bestia.",
	ANNOUNCE_HUNT_LOST_TRAIL = "No hay mas rastro.",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "En este suelo no pueden haber huellas.",
	ANNOUNCE_INV_FULL = "Inventario lleno!",
	ANNOUNCE_KNOCKEDOUT = "Que dolor de cabeza!",
	ANNOUNCE_LOWRESEARCH = "Unlucky.",
	ANNOUNCE_MOSQUITOS = "POLILLAS!",
    ANNOUNCE_NOWARDROBEONFIRE = "Que se quema!",
    ANNOUNCE_NODANGERGIFT = "El regalito lo abro cuando no hayan monstruos",
    ANNOUNCE_NOMOUNTEDGIFT = "Tengo que dejar de montar.",
	ANNOUNCE_NODANGERSLEEP = "No toca siesta!",
	ANNOUNCE_NODAYSLEEP = "Si me duermo ahora no voy al sqrups.",
	ANNOUNCE_NODAYSLEEP_CAVE = "No estoy cansado.",
	ANNOUNCE_NOHUNGERSLEEP = "Sin cenar mi tripa no quiere dormir!",
	ANNOUNCE_NOSLEEPONFIRE = "Me cuezo.",
	ANNOUNCE_NODANGERSIESTA = "Not siesta time!",
	ANNOUNCE_NONIGHTSIESTA = "La siesta mejor por la tarde.",
	ANNOUNCE_NONIGHTSIESTA_CAVE = "No estoy muy sleepy.",
	ANNOUNCE_NOHUNGERSIESTA = "La siesta despues de comer!",
	ANNOUNCE_NODANGERAFK = "FIGHT OR BE FORGOTTEN!",
	ANNOUNCE_NO_TRAP = "Facilito.",
	ANNOUNCE_PECKED = "Paso!",
	ANNOUNCE_QUAKE = "No mola.",
	ANNOUNCE_RESEARCH = "Nunca te vas a dormir sin saber algo nuevo!",
	ANNOUNCE_SHELTER = "Gracias a la naturaleza!",
	ANNOUNCE_THORNS = "Ay!",
	ANNOUNCE_BURNT = "Calentito!",
	ANNOUNCE_TORCH_OUT = "No veo!",
	ANNOUNCE_THURIBLE_OUT = "Esta vacio.",
	ANNOUNCE_FAN_OUT = "Y volo.",
    ANNOUNCE_COMPASS_OUT = "Ya no se a donde voy.",
	ANNOUNCE_TRAP_WENT_OFF = "Oops.",
	ANNOUNCE_UNIMPLEMENTED = "Not ready.",
	ANNOUNCE_WORMHOLE = "Eso no ha sido de persona mentalmente estable.",
	ANNOUNCE_TOWNPORTALTELEPORT = "Buen tp.",
	ANNOUNCE_CANFIX = "\nLo puedo arreglar!",
	ANNOUNCE_ACCOMPLISHMENT = "Perfecto!",
	ANNOUNCE_ACCOMPLISHMENT_DONE = "Alguien ha visto eso?",	
	ANNOUNCE_INSUFFICIENTFERTILIZER = "La plantita sigue con hambre.",
	ANNOUNCE_TOOL_SLIP = "Se me resbala!",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "SPOOKY!",
	ANNOUNCE_TOADESCAPING = "El sapo se pira.",
	ANNOUNCE_TOADESCAPED = "El sapo se fue.",


	ANNOUNCE_DAMP = "Agüita.",
	ANNOUNCE_WET = "Estoy mojadito.",
	ANNOUNCE_WETTER = "Estoy muy mojadito!",
	ANNOUNCE_SOAKED = "No se puede estar mas mojadito.",

	ANNOUNCE_WASHED_ASHORE = "Mojado pero no hundido.",

    ANNOUNCE_DESPAWN = "Veo la luz!",
	ANNOUNCE_BECOMEGHOST = "oOooOooo spooky!!",
	ANNOUNCE_GHOSTDRAIN = "Ya no soy humano...",
	ANNOUNCE_PETRIFED_TREES = "Los arboles no gritan.",
	ANNOUNCE_KLAUS_ENRAGE = "Esta enfadado!!",
	ANNOUNCE_KLAUS_UNCHAINED = "His chains are unbound!",
	ANNOUNCE_KLAUS_CALLFORHELP = "Esta pidiendo ayuda!",

	ANNOUNCE_MOONALTAR_MINE =
	{
		GLASS_MED = "Hay alguien ahi.",
		GLASS_LOW = "Casi.",
		GLASS_REVEAL = "Libre!",
		IDOL_MED = "Hay alguien ahi.",
		IDOL_LOW = "Casi.",
		IDOL_REVEAL = "Libre!",
		SEED_MED = "Hay alguien ahi.",
		SEED_LOW = "Casi.",
		SEED_REVEAL = "Libre!",
	},

    --hallowed nights
    ANNOUNCE_SPOOKED = "Lo has visto?!",
	ANNOUNCE_BRAVERY_POTION = "Como un dragon.",
	ANNOUNCE_MOONPOTION_FAILED = "Creo que necesitaba un poco mas...",

    --lavaarena event
    ANNOUNCE_REVIVING_CORPSE = "Te echo una mano.",
    ANNOUNCE_REVIVED_OTHER_CORPSE = "Como nuevo!",
    ANNOUNCE_REVIVED_FROM_CORPSE = "Mucho mejor, bien hecho.",

    ANNOUNCE_FLARE_SEEN = "Quien ha lanzado esa bengala?",
    ANNOUNCE_OCEAN_SILHOUETTE_INCOMING = "Uh-oh. Monstruos marinos!",
    ...
    --quagmire event
    QUAGMIRE_ANNOUNCE_NOTRECIPE = "Esos ingredientes no funcionan juntos.",
    QUAGMIRE_ANNOUNCE_MEALBURNT = "Mucho tiempo encendido.",
    QUAGMIRE_ANNOUNCE_LOSE = "No bueno.",
    QUAGMIRE_ANNOUNCE_WIN = "Nos vamos!",
    ...
    ANNOUNCE_ATTACH_BUFF_ELECTRICATTACK    = "Electrizante!",
    ANNOUNCE_ATTACH_BUFF_ATTACK            = "I am THE enemy!",
    ANNOUNCE_ATTACH_BUFF_PLAYERABSORPTION  = "Me siento seguroo!",
    ANNOUNCE_ATTACH_BUFF_WORKEFFECTIVENESS = "Mango loco y productividad!",
    ANNOUNCE_ATTACH_BUFF_MOISTUREIMMUNITY  = "Estoy seco!",
    
    ANNOUNCE_DETACH_BUFF_ELECTRICATTACK    = "No bzzzzz anymore.",
    ANNOUNCE_DETACH_BUFF_ATTACK            = "Ya no me los bajo.",
    ANNOUNCE_DETACH_BUFF_PLAYERABSORPTION  = "Se acabo el tanqueo.",
    ANNOUNCE_DETACH_BUFF_WORKEFFECTIVENESS = "Procrastinar",
    ANNOUNCE_DETACH_BUFF_MOISTUREIMMUNITY  = "Ya no estoy seco.",
	...
	BATTLECRY =
	{
		GENERIC = "A por los ojos!",
		PIG = "Quien teme al lobo feroz!",
		PREY = "VEN AQUI!",
		SPIDER = "Farmear arañas!",
		SPIDER_WARRIOR = "Facilito!",
		DEER = "Muereee!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "No huyo, le dejo vivir!",
		PIG = "Soy vegetariano!",
		PREY = "Vuelve aqui!",
		SPIDER = "No me gustan las arañas.",
		SPIDER_WARRIOR = "Correr!",
	},
	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "Imposible.",
        MULTIPLAYER_PORTAL_MOONROCK = "Ni idea.",
        MOONROCKIDOL = "Solo adoro a las mujeres, la naturaleza y el vino.",
        CONSTRUCTION_PLANS = "Vigas!",

        ANTLION =
        {
            GENERIC = "Quiere algo.",
            VERYHAPPY = "Que maja.",
            UNHAPPY = "Se ha chinado.",
        },
        ANTLIONTRINKET = "Alguien quiere esto?.",
        SANDSPIKE = "Que me pinchan",
        SANDBLOCK = "Arena!",
        GLASSSPIKE = "Que me pinchan.",
        GLASSBLOCK = "Cristalito.",
        ABIGAIL_FLOWER =
        {
            GENERIC ="Es preciosa.",
            LONG = "Esta creciendo.",
            MEDIUM = "Cada vez esta mas grande.",
            SOON = "Le pasa algo a la flor!",
            HAUNTED_POCKET = "No se si deberia tenerla yo.",
