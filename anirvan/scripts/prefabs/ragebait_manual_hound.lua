...
local function OnRead(inst, reader)
    if reader and reader.components and reader.components.ragebait_controller then
        reader.components.ragebait_controller:CraftManual("ragebait_manual_hound")
        if reader.components.talker then
            reader.components.talker:Say("I have learned to rouse the hound's anger!")
        end
...
return Prefab("ragebait_manual_hound", fn, assets)